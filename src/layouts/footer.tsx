                ...
                <div className='row py-4'>
                    <div className='col-lg-3 col-md-6 mb-5'>
                        ...
                        <p className='font-weight-medium'>
                            <FontAwesomeIcon icon={faMapMarkerAlt} /> 123 Street, New York, USA</p>
                        <p className='font-weight-medium'><FontAwesomeIcon icon={faPhoneAlt} /> +012 345 67890</p>
                        <p className='font-weight-medium'><FontAwesomeIcon icon={faEnvelope} /> info@example.com</p>
                    </div>
                </div>
            </div>
        </footer>
