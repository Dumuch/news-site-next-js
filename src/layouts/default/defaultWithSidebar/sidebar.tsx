        ...
        <>
            <div className="mb-3">
                ...
                <div className="bg-white border border-top-0 p-3">
                    <a href="" className="d-block w-100 text-white text-decoration-none mb-3"
                    >
                        <i className="fab fa-facebook-f text-center py-4 mr-3"
                        ></i>
                        <span className="font-weight-medium">12,345 Fans</span>
                    </a>
                    <a href="" className="d-block w-100 text-white text-decoration-none mb-3"
                    >
                        <i className="fab fa-twitter text-center py-4 mr-3"
                        ></i>
                        <span className="font-weight-medium">12,345 Followers</span>
                    </a>
                    <a href="" className="d-block w-100 text-white text-decoration-none mb-3"
                    >
                        <i className="fab fa-linkedin-in text-center py-4 mr-3"
                        ></i>
                        <span className="font-weight-medium">12,345 Connects</span>
                    </a>
                    <a href="" className="d-block w-100 text-white text-decoration-none mb-3"
                    >
                        <i className="fab fa-instagram text-center py-4 mr-3"
                        ></i>
                        <span className="font-weight-medium">12,345 Followers</span>
                    </a>
                    <a href="" className="d-block w-100 text-white text-decoration-none mb-3"
                    >
                        <i className="fab fa-youtube text-center py-4 mr-3"
                        ></i>
                        <span className="font-weight-medium">12,345 Subscribers</span>
                    </a>
                    <a href="" className="d-block w-100 text-white text-decoration-none"
                    >
                        <i className="fab fa-vimeo-v text-center py-4 mr-3"
                        ></i>
                        <span className="font-weight-medium">12,345 Followers</span>
                    </a>
                </div>
                ...
                <div className="bg-white border border-top-0 p-3">
                    <div className="d-flex align-items-center bg-white mb-3"  >
                        ...
                        <div
                            ...
                            <div className="mb-2">
                                <a className="badge badge-primary text-uppercase font-weight-semi-bold p-1 mr-2"
                                   href="">Business</a>
                                <a className="text-body" href=""><small>Jan 01, 2045</small></a>
                            </div>
                            <a className="h6 m-0 text-secondary text-uppercase font-weight-bold"
