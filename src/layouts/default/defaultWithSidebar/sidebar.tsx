            ...
            <div className="mb-3">
                ...
                <div className="bg-white border border-top-0 p-3">
                    <a href="" className="d-block w-100 text-white text-decoration-none mb-3">
                        <i className="fab fa-facebook-f text-center py-4 mr-3"></i>
                        <span className="font-weight-medium">12,345 Fans</span>
                    </a>
                    <a href="" className="d-block w-100 text-white text-decoration-none mb-3">
                        <i className="fab fa-twitter text-center py-4 mr-3"></i>
                        <span className="font-weight-medium">12,345 Followers</span>
                    </a>
                    <a href="" className="d-block w-100 text-white text-decoration-none mb-3">
                        <i className="fab fa-linkedin-in text-center py-4 mr-3"></i>
                        <span className="font-weight-medium">12,345 Connects</span>
                    </a>
                    <a href="" className="d-block w-100 text-white text-decoration-none mb-3">
                        <i className="fab fa-instagram text-center py-4 mr-3"></i>
                        <span className="font-weight-medium">12,345 Followers</span>
                    </a>
                    <a href="" className="d-block w-100 text-white text-decoration-none mb-3">
                        <i className="fab fa-youtube text-center py-4 mr-3"></i>
                        <span className="font-weight-medium">12,345 Subscribers</span>
                    </a>
                    <a href="" className="d-block w-100 text-white text-decoration-none">
                        <i className="fab fa-vimeo-v text-center py-4 mr-3"></i>
                        <span className="font-weight-medium">12,345 Followers</span>
                    </a>
                </div>
            </div>
