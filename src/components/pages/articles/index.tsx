        ...
        <div className='container-fluid pt-5 mb-3'>
            <div className='container'>
                        ...
                        {categories.map((category) => {
                            ...
                            return (
                                <div className={'col-auto mb-3'} key={category.id}>
                                    <BadgeComponent className={`text-nowrap ${isActive && badgeStyles.active}`}
                ...
                {articles.length > 0 ? (
                    ...
                    <div className='row'>
                        <div className={'col'}><span className={'h4 m-0 text-uppercase font-weight-semi-bold'}>Not found articles</span>
                        </div>
                    </div>
                )}
            </div>
